...
export class Inital1785784670748 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "system_feature_access_control" ("group_id" integer NOT NULL, "feature_id" integer NOT NULL, "is_allowed" boolean NOT NULL DEFAULT true, CONSTRAINT "PK_e92b8f8d1e8509a940c2b8e941d" PRIMARY KEY ("group_id", "feature_id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "system_feature_access_control" ADD CONSTRAINT "FK_999c029061b6e7961cc772b5f70" FOREIGN KEY ("group_id") REFERENCES "system_feature_groups"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "system_feature_access_control" ADD CONSTRAINT "FK_5e5ab79733772a2652bd93ef886" FOREIGN KEY ("feature_id") REFERENCES "system_features"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "system_feature_access_control" DROP CONSTRAINT "FK_5e5ab79733772a2652bd93ef886"`,
    );
    await queryRunner.query(
      `ALTER TABLE "system_feature_access_control" DROP CONSTRAINT "FK_999c029061b6e7961cc772b5f70"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`DROP TABLE "system_feature_access_control"`);
